...
angular.module("ui.bootstrap.position", []).factory("$uibPosition", [ "$document", "$window", function($document, $window) {
    ...
    this.init = function(_ngModel_) {
        ...
        value ? $scope.disabled ? (console.log("closing!"), $scope.isOpen = !1) : $timeout(function() {
            angular.element($popup[0]).addClass("show"), positionPopup(), onOpenFocus && $scope.$broadcast("uib:datepicker.focus"), 
...
//# sourceMappingURL=ui-bootstrap.map