...
angular.module("ui.bootstrap.position", []).factory("$uibPosition", [ "$document", "$window", function($document, $window) {
    ...
    function positionPopup() {
        if ($scope.isOpen) {
            ...
            }), dpElement.addClass("show"), dpElement.hasClass("uib-position-measure") && dpElement.removeClass("uib-position-measure");
        }
    }
    ...
    this.init = function(_ngModel_) {
        ...
        angular.element($popup[0].querySelector(".uib-datepicker-popup"));
